 ...
 * accessible from everywhere without remapping.                               //global_BB不用重映射
 *
 ...
 * blackboard of the hierarchy".                                               //重点：“@”的含义
 *
 ...
 * When accessing the blackboard directly in the main loop, no prefix "@" is needed.  //主循环里面不需要“@”来remap
 */
